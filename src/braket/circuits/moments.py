...
class Moments(Mapping[MomentsKey, Instruction]):
    ...
    def add(self, instructions: Union[Iterable[Instruction], Instruction], noise_index: int = 0) -> None:
        """
        Add one or more instructions to self.

        Args:
            instructions (Union[Iterable[Instruction], Instruction]): Instructions to add to self. The instruction is
